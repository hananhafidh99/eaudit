            ...
            <form action="{{ url('surat_dalamKota/' . $penugasanedit['id']) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-5 mt-4">
                        <input type="text" name="noSurat" value="{{ old('noSurat', $penugasanedit['noSurat']) }}"
                            class="form-control">
                    </div>
                    <div class="col-2 mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-3 mt-3">
                        <input type="text" name="Tanggalsurat" class="form-control datepicker"
                            value="{{ old('Tanggalsurat', $penugasanedit['tanggalAwalPenugasan']) }}">
                    </div>
                    <div class="col-1 mt-4">
                        <label for="">s/d</label>
                    </div>
                    <div class="col-5 mt-3">
                        <input type="text" name="TanggalAkhir" class="form-control datepicker" id="tp"
                            value="{{ old('TanggalAkhir', $penugasanedit['tanggalAkhirPenugasan']) }}">
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 mt-3">
                                ...
                                @if(isset($suratTugas['tugas'][$item['id']]))
                                    <input type="hidden" name="ubahtugas[{{ $suratTugas['tugas'][$item['id']]->id }}][id_peran]"
                                        value="{{ $item['id'] }}">
                                @endif
                                <select class="form-control namaPeran" @if(isset($suratTugas['tugas'][$item['id']]))
                                name="ubahtugas[{{ $suratTugas['tugas'][$item['id']]->id }}][id_pegawai]" @else
                                    name="tugas[{{ $item['id'] }}][id_pegawai]" @endif>
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-3 mt-3">
                                ...
                                @endphp
                                {{-- @dd($selectedvalue) --}}
                                <input type="text" @if(isset($suratTugas['tugas'][$item['id']]))
                                name="ubahtugas[{{ $suratTugas['tugas'][$item['id']]->id }}][tanggalAwalPemeriksaan]" @else
                                    name="tugas[{{ $item['id'] }}][tanggalAwalPemeriksaan]" @endif class="form-control datepicker2"
                                    value="{{ $selectedvalue }}">
                            </div>
                            <div class="col-2 mt-3">
                                ...
                                @endphp
                                <input type="text" @if(isset($suratTugas['tugas'][$item['id']]))
                                name="ubahtugas[{{ $suratTugas['tugas'][$item['id']]->id }}][tanggalAkhirPemeriksaan]" @else
                                    name="tugas[{{ $item['id'] }}][tanggalAkhirPemeriksaan]" @endif class="form-control datepicker2"
                                    value="{{ $selectedvalue }}">
                            </div>
                        </div>
                    @else
                        @for ($i = 1; $i <= 15; $i++)
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 mt-3">
                                    ...
                                    @endphp
                                    <input type="text" name="{{ $tagtglAwalupi }}" class="form-control datepicker2"
                                        value="{{ $selectedvalue }}">
                                </div>
                                <div class="col-2 mt-3">
                                    @php
                                    ...
                                    @endphp
                                    <input type="text" name="{{ $tagtglAkhirupi }}" class="form-control datepicker2"
                                        value="{{ $selectedvalue }}">
                                </div>
                            </div>
                        @endfor
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" name="tanggalterbitSurat" class="form-control datepicker"
                            value="{{ $penugasanedit['tanggalTerbitPenugasan'] }}">
                    </div>
                </div>
