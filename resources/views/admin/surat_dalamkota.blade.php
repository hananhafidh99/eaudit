...
@section('content')
    ...
    <div class="d-flex justify-content-end "><a href="{{ url('surat_dalamKota_create') }}"
            class="btn btn-success mb-3">Tambah Penugasan</a>
    </div>
        ...
        <tbody>
            ...
            @foreach ($data['data'] as $index => $v)
                <tr>
                    ...
                    <td>{{ $v['obrik'] }}</td>
                    <td scope="row">
                        <a href="{{ url('surat_dalamKota/ST/' . $v['id']) }}" target="_blank"><i
                                class="far fa-file-pdf fa-2x ms-2"></i></a>
                        <a href="{{ url('surat_dalamKota/suratDinas/' . $v['id']) }}" target="_blank"><i
                                class="far fa-file-pdf fa-2x ms-2"></i></a>
                        <a href="{{ url('surat_dalamKota/sppd/' . $v['id']) }}" target="_blank"><i
                                class="far fa-file-pdf fa-2x ms-2"></i></a>
                        <a href="{{ url('surat_dalamKota/buktipenerimaan/' . $v['id']) }}" target="_blank"><i
                                class="far fa-file-pdf fa-2x ms-2"></i></a>
                    </td>
                    <td>
                        <a href="{{ url('surat_dalamKota/SD/' . $v['id']) }}" target="_blank"><i
                                class="far fa-file-pdf fa-2x ms-2"></i></a>
                    </td>
                    <td scope="row">
                        <a href="{{ url('surat_dalamKota/' . $v['id'] . '/edit') }}" class="btn"
                            style="background-color: #FFFDD0; border-color: #FFFDD0; color: #5a5a5a;"> <i
                                class="fas fa-eye"></i></a>
                        <a href="{{ url('perjalananDalam/suratDinas/' . $v['id']) }}" class="btn btn-danger"><i
